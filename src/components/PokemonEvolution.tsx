...
/**
 * Componente para exibir linha evolutiva de Pokémon
 * Mostra evoluções, métodos de evolução e formas regionais
 */
const PokemonEvolution = memo<PokemonEvolutionProps>(({ evolutionData, loading, error }) => {
  ...
  /**
   * Formata nome do item de evolução
   */
  ...
  /**
   * Obtém cor baseada no tipo de evolução
   */
