...
const PokemonElegant = memo<PokemonElegantProps>(({ pokemon, error, loading }) => {
  ...
  const pokemonData = useMemo(() => {
    ...
    return {
      ...
      height: pokemon.height / 10, // Converter de decímetros para metros
